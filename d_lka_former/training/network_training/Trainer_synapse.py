...
from d_lka_former.training.network_training.network_trainer_synapse import (
...
class Trainer_synapse(NetworkTrainer_synapse):
    ...
    def preprocess_patient(self, input_files):
        ...
        assert preprocessor_class is not None, (
            "Could not find preprocessor %s in d_lka_former.preprocessing"
            % preprocessor_name
        )
