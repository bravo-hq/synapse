...
base = (
    os.environ["d_lka_former_raw_data_base"]
    if "d_lka_former_raw_data_base" in os.environ.keys()
    else None
)
preprocessing_output_dir = (
    os.environ["d_lka_former_preprocessed"]
    if "d_lka_former_preprocessed" in os.environ.keys()
    else None
)
...
if base is not None:
    ...
    print(
        "d_lka_former_raw_data_base is not defined and model can only be used on data for which preprocessed files "
...
if preprocessing_output_dir is not None:
    ...
    print(
        "d_lka_former_preprocessed is not defined and model can not be used for preprocessing "
